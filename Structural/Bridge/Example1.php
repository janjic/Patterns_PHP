 ...
 * In this example we have BridgeBook which uses either BridgeBookCapsImp or BridgeBookStarsImp. BridgeBook will assign
 * one implementation or the other each time BridgeBook is instantiated.
